...
export async function action({ request }: Route.ActionArgs) {
  ...
  //imaginamos que hemos actualizado el nombre en la base de datos, y devolvemos el nuevo nombre

  return { success: true, updatedName: name };
}

export default function ActionServer({ loaderData }: Route.ComponentProps) {
